...
(function(f, define) {
    ...
    !function(e, t, n) {
        ...
        function s(t, n) {
            ...
            h = d[0].style,
            d.is(":hidden") && d.show(),
            i = St.test(h.width) || St.test(h.height),
            i || d.css({
                width: t.outerWidth(),
            ...
            l = St.test(r),
            c = St.test(s),
            u.opera && (o.left = o.right = o.bottom = 5),
            i = l || c,
            ...
            u.msie && xt.floor(u.version) <= 7 && (t.css({
                zoom: 1
            }),
        ...
        function c(e, t) {
            ...
            for (n in t)
                i = t[n],
                o = typeof i,
                r = o === It && null  !== i ? i.constructor : null ,
                r && r !== Array && r !== s && r !== l && r !== d && r !== h ? i instanceof Date ? e[n] = new Date(i.getTime()) : E(i.clone) ? e[n] = i.clone() : (a = e[n],
                e[n] = typeof a === It ? a || {} : {},
                c(e[n], i)) : o !== Lt && (e[n] = i);
            return e
        }
        ...
        function p(e) {
            return "visible" != f(e, ["overflow"]).overflow
        }
        function g(e) {
            var t, n = 0;
            for (t in e)
        ...
        function m(e, n, i) {
            n || (n = "offset");
            var o = e[n]();
            return Ct.browser.msie && (Ct.pointers || Ct.msPointers) && !i && (o.top -= t.pageYOffset - document.documentElement.scrollTop,
        ...
        function k(e, t) {
            ...
            t = t.replace(it, "-$1"),
            i = e.getAttribute("data-" + mt.ns + t),
            null  === i ? i = n : "null" === i ? i = null  : "true" === i ? i = !0 : "false" === i ? i = !1 : At.test(i) ? i = parseFloat(i) : tt.test(i) && !nt.test(i) && (i = Function("return (" + i + ")")()),
            i
        }
        function C(t, i) {
            var o, r, a = {};
            for (o in i)
                r = k(t, o),
                r !== n && (et.test(o) && (r = mt.template(e("#" + r).html())),
                a[o] = r);
            return a
        }
        function S(t, n) {
        ...
        var M, E, I, B, z, L, F, R, O, H, N, V, U, W, j, G, q, $, Y, Q, X, K, Z, J, et, tt, nt, it, ot, rt, at, st, lt, ct, dt, ht, ut, ft, pt, gt, mt = t.kendo = t.kendo || {
            cultures: {}
        }, vt = e.extend, _t = e.each, yt = e.isArray, wt = e.proxy, bt = e.noop, xt = Math, kt = t.JSON || {}, Ct = {}, St = /%/, Tt = /\{(\d+)(:[^\}]+)?\}/g, Dt = /(\d+(?:\.?)\d*)px\s*(\d+(?:\.?)\d*)px\s*(\d+(?:\.?)\d*)px\s*(\d+)?/i, At = /^(\+|-?)\d+(\.?)\d*$/, Pt = "function", Mt = "string", Et = "number", It = "object", Bt = "null", zt = "boolean", Lt = "undefined", Ft = {}, Rt = {}, Ot = [].slice, Ht = t.Globalize;
        mt.version = "2015.2.624",
        i.extend = function(e) {
            var t, n, i = function() {}
            ...
            for (t in e)
                n[t] = null  != e[t] && e[t].constructor === Object ? vt(!0, {}, i.prototype[t], e[t]) : e[t];
        ...
        M = {
            ...
            compile: function(e, t) {
                ...
                for (d += c ? "with(" + s + "){" : "",
                d += "$kendoOutput=",
                i = e.replace(R, "__CURLY__").replace(F, "#=$kendoHtmlEncode($1)#").replace(O, "}").replace(H, "__SHARP__").split("#"),
                r = 0; i.length > r; r++)
                    d += o(i[r], r % 2 === 0);
                d += c ? ";}" : ";",
        ...
        function() {
            ...
            function t(r, a) {
                ...
                if (g && typeof g === It && typeof g.toJSON === Pt && (g = g.toJSON(r)),
                typeof o === Pt && (g = o.call(a, r, g)),
                f = typeof g,
                f === Mt)
                    return e(g);
                if (f === Et)
                    return isFinite(g) ? g + "" : Bt;
                if (f === zt || f === Bt)
                    return g + "";
                if (f === It) {
                    if (!g)
            ...
            typeof kt.stringify !== Pt && (kt.stringify = function(e, r, a) {
                ...
                typeof a === Et)
                    ...
                    typeof a === Mt && (i = a);
                if (o = r,
                r && typeof r !== Pt && (typeof r !== It || typeof r.length !== Et))
        ...
        function() {
            ...
            function s(e, t, o) {
                ...
                if (G && (e = -e),
                (t.indexOf("'") > -1 || t.indexOf('"') > -1 || t.indexOf("\\") > -1) && (t = t.replace(u, function(e) {
        ...
        function() {
            ...
            function l(e, i, a) {
                ...
                d = i.length; d > F; F++)
                    ...
                    O)
                        ...
                        null  !== E && c > 2)
                            continue;if (E = 3 > c ? S(2) : T(A._lowerDays[3 == c ? "namesAbbr" : "names"], !0),
                        null  === E || t(E, 1, 31))
                            return null
                    } else if ("M" === l) {
                        if (c = C("M"),
                        ...
                        null  === P)
                            return null ;
                        2 == c && ("string" == typeof N && (N = V + parseInt(N, 10)),
                        P = V - V % 100 + P,
                        P > N && (P -= 100))
                    } else if ("h" === l) {
                        if (C("h"),
                        ...
                        if (m = e.substr(R, 6).match(c > 2 ? f : u),
                        !m)
                            return null ;
                        if (m = m[0].split(":"),
                        w = m[0],
            ...
            mt.parseDate = function(e, t, n) {
                ...
                e && 0 === e.indexOf("/D") && (o = p.exec(e)))
                    ...
                    s && (s = c(s[0]),
                    o = mt.timezone.apply(o, 0),
                    o = mt.timezone.convert(o, 0, -1 * s)),
                    o;
                if (n = mt.getCulture(n),
                !t) {
                    for (t = [],
            ...
            mt.parseFloat = function(e, t, n) {
                ...
                return h.test(e) ? (e = parseFloat(e.replace(r["."], ".")),
                isNaN(e) && (e = null ),
                e) : u > 0 ? null  : (u = u > -1,
            ...
            mt.parseFloat = function(t, i) {
                return typeof t === Et ? t : t === n || null  === t ? null  : (e.isPlainObject(i) && (i = i.name),
                t = Ht.parseFloat(t, i),
                isNaN(t) ? null  : t)
            }
            )
        ...
        function() {
            ...
            Ct.scrollbar = function(e) {
                if (isNaN(Ct._scrollbar) || e) {
                    ...
                    Ct._scrollbar = t = n.offsetWidth - n.scrollWidth,
            ...
            Ct.touch = "ontouchstart" in t,
            Ct.msPointers = t.MSPointerEvent,
            Ct.pointers = t.PointerEvent,
            o = Ct.transitions = !1,
            r = Ct.transforms = !1,
            a = "HTMLElement" in t ? HTMLElement.prototype : [],
            Ct.hasHW3D = "WebKitCSSMatrix" in t && "m11" in new t.WebKitCSSMatrix || "MozPerspective" in document.documentElement.style || "msPerspective" in document.documentElement.style,
            _t(["Moz", "webkit", "O", "ms"], function() {
                var e, t = "" + this, a = typeof i.style[t + "Transition"] === Mt;
                return a || typeof i.style[t + "Transform"] === Mt ? (e = t.toLowerCase(),
                r = {
                    css: "ms" != e ? "-" + e + "-" : "",
                    prefix: t,
            ...
            Ct.transforms = r,
            Ct.transitions = o,
            Ct.devicePixelRatio = t.devicePixelRatio === n ? 1 : t.devicePixelRatio;
            try {
                Ct.screenWidth = t.outerWidth || t.screen ? t.screen.availWidth : t.innerWidth,
                Ct.screenHeight = t.outerHeight || t.screen ? t.screen.availHeight : t.innerHeight
            } catch (h) {
                Ct.screenWidth = t.screen.availWidth,
                Ct.screenHeight = t.screen.availHeight
            }
            Ct.detectOS = function(e) {
                ...
                for (i in s)
                    if (s.hasOwnProperty(i) && (r = e.match(s[i]))) {
                        ...
                        o.cordova = typeof t.PhoneGap !== Lt || typeof t.cordova !== Lt,
                        o.appMode = t.navigator.standalone || /file|local|wmapp/.test(t.location.protocol) || o.cordova,
                        o.android && (1.5 > Ct.devicePixelRatio && 400 > o.flatVersion || a) && (Ct.screenWidth > 800 || Ct.screenHeight > 800) && (o.tablet = i);
                        break
                    }
                return o
            }
            ,
            s = Ct.mobileOS = Ct.detectOS(navigator.userAgent),
            Ct.wpDevicePixelRatio = s.wp ? screen.width / 320 : 0,
            Ct.kineticScrollNeeded = s && (Ct.touch || Ct.msPointers || Ct.pointers),
            Ct.hasNativeScrolling = !1,
            (s.ios || s.android && s.majorVersion > 2 || s.wp) && (Ct.hasNativeScrolling = s),
            Ct.mouseAndTouchPresent = Ct.touch && !(Ct.mobileOS.ios || Ct.mobileOS.android),
            Ct.detectBrowser = function(e) {
                var t, n = !1, i = [], o = {
                    webkit: /(chrome)[ \/]([\w.]+)/i,
                    safari: /(webkit)[ \/]([\w.]+)/i,
            ...
            ,
            Ct.browser = Ct.detectBrowser(navigator.userAgent),
            Ct.zoomLevel = function() {
                var e, n, i;
                try {
                    return e = Ct.browser,
                    n = 0,
                    i = document.documentElement,
                    e.msie && 11 == e.version && i.scrollHeight > i.clientHeight && !Ct.touch && (n = Ct.scrollbar()),
                    Ct.touch ? i.clientWidth / t.innerWidth : e.msie && e.version >= 10 ? ((top || t).document.documentElement.offsetWidth + n) / (top || t).innerWidth : 1
                } catch (o) {
                    return 1
                }
            }
            ...
            function(t) {
                ...
                n && (n = "k-" + n + " k-" + n + o),
                Ct.mobileOS && (n += " k-mobile"),
                i.addClass(n)
            }
            (Ct.browser),
            Ct.eventCapture = document.documentElement.addEventListener,
            l = document.createElement("input"),
            Ct.placeholder = "placeholder" in l,
            Ct.propertyChangeEvent = "onpropertychange" in l,
            Ct.input = function() {
            ...
            ,
            Ct.pushState = t.history && t.history.pushState,
            c = document.documentMode,
            Ct.hashChange = "onhashchange" in t && !(Ct.browser.msie && (!c || 8 >= c))
        }
        (),
        U = {
            left: {
        ...
        Ct.touch ? Ct.mobileOS ? (Ct.mousedown = "touchstart",
        Ct.mouseup = "touchend",
        Ct.mousemove = "touchmove",
        Ct.mousecancel = "touchcancel",
        Ct.click = "touchend",
        Ct.resize = "orientationchange") : (Ct.mousedown = "mousedown touchstart",
        Ct.mouseup = "mouseup touchend",
        Ct.mousemove = "mousemove touchmove",
        Ct.mousecancel = "mouseleave touchcancel",
        Ct.click = "click",
        Ct.resize = "resize") : Ct.pointers ? (Ct.mousemove = "pointermove",
        Ct.mousedown = "pointerdown",
        Ct.mouseup = "pointerup",
        Ct.mousecancel = "pointercancel",
        Ct.click = "pointerup",
        Ct.resize = "orientationchange resize") : Ct.msPointers ? (Ct.mousemove = "MSPointerMove",
        Ct.mousedown = "MSPointerDown",
        Ct.mouseup = "MSPointerUp",
        Ct.mousecancel = "MSPointerCancel",
        Ct.click = "MSPointerUp",
        Ct.resize = "orientationchange resize") : (Ct.mousemove = "mousemove",
        Ct.mousedown = "mousedown",
        Ct.mouseup = "mouseup",
        Ct.mousecancel = "mouseleave",
        Ct.click = "click",
        Ct.resize = "resize"),
        X = function(e, t) {
        ...
        Z = z.extend({
            init: function(e, t) {
                var n, i = this;
                i.element = mt.jQuery(e).handler(i),
                i.angular("init", t),
                z.fn.init.call(i),
                ...
                t = i.options = vt(!0, {}, i.options, t),
                n && (t.dataSource = n),
                i.element.attr(mt.attr("role")) || i.element.attr(mt.attr("role"), (t.name || "").toLowerCase()),
        ...
        nt = /^\{(\d+)(:[^\}]+)?\}|^\[[A-Za-z_]*\]$/,
        it = /([A-Z])/g,
        mt.initWidget = function(i, o, r) {
            var a, s, l, c, d, h, u, f, p, g, m, v, _;
            if (r ? r.roles && (r = r.roles) : r = mt.ui.roles,
            i = i.nodeType ? i : i[0],
            h = i.getAttribute("data-" + mt.ns + "role")) {
                p = -1 === h.indexOf("."),
                l = p ? r[h] : mt.getter(h)(t),
                m = e(i).data(),
                v = l ? "kendo" + l.fn.options.prefix + l.fn.options.name : "",
                g = p ? RegExp("^kendo.*" + h + "$", "i") : RegExp("^" + v + "$", "i");
                for (_ in m)
                    if (_.match(g)) {
                        if (_ !== v)
                            return m[_];
                ...
                if (l) {
                    for (f = k(i, "dataSource"),
                    o = e.extend({}, C(i, l.fn.options), o),
                    f && (o.dataSource = typeof f === Mt ? mt.getter(f)(t) : f),
                    c = 0,
                    d = l.fn.events.length; d > c; c++)
                        s = l.fn.events[c],
                        u = k(i, s),
                        u !== n && (o[s] = mt.getter(u)(t));
        ...
        mt.destroy = function(t) {
            e(t).find("[data-" + mt.ns + "role]").addBack().each(function() {
                var t, n = e(this).data();
                for (t in n)
                    0 === t.indexOf("kendo") && typeof n[t].destroy === Pt && n[t].destroy()
            }
            )
        }
        ,
        ...
        vt(mt.ui, {
            ...
            plugin: function(t, i, o) {
                ...
                e.fn[a] = function(i) {
                    var o, r = this;
                    return typeof i === Mt ? (o = Ot.call(arguments, 1),
                    this.each(function() {
                        var t, s, l = e.data(this, a);
                        if (!l)
                            throw Error(mt.format("Cannot call method '{0}' of {1} before it is initialized", i, a));
                        if (t = l[i],
                        typeof t !== Pt)
                            throw Error(mt.format("Cannot find method '{0}' of {1}", i, a));
        ...
        vt(mt.mobile, {
            ...
            ui: {
                Widget: rt,
                DataBoundWidget: J.extend(rt.prototype),
                roles: {},
                plugin: function(e) {
        ...
        mt.touchScroller = function(t, n) {
            return e(t).map(function(t, i) {
                return i = e(i),
                Ct.kineticScrollNeeded && mt.mobile.ui.Scroller && !i.data("kendoMobileScroller") ? (i.kendoMobileScroller(n),
        ...
        mt.widgetInstance = function(e, n) {
            ...
            if (s) {
                ...
                n)
                    ...
                    l = [mt.ui.roles[s], mt.dataviz.ui.roles[s], mt.mobile.ui.roles[s]];
                for (s.indexOf(".") >= 0 && (l = [mt.getter(s)(t)]),
                i = 0,
                o = l.length; o > i; i++)
                    if (r = l[i],
        ...
        st = "label, input, [data-rel=external]",
        lt = {
            setupMouseMute: function() {
                ...
                if (!lt.mouseTrap && Ct.eventCapture)
                    ...
                    lt.captureMouse = !1,
                    t = function(t) {
                        lt.captureMouse && ("click" === t.type ? lt.bustClick && !e(t.target).is(st) && (t.preventDefault(),
                        t.stopPropagation()) : t.stopPropagation())
                    }
                    ; i > n; n++)
                        o.addEventListener(at[n], t, !0)
            },
            muteMouse: function(e) {
                lt.captureMouse = !0,
                e.data.bustClick && (lt.bustClick = !0),
                clearTimeout(lt.mouseTrapTimeoutID)
            },
            unMuteMouse: function() {
                clearTimeout(lt.mouseTrapTimeoutID),
                lt.mouseTrapTimeoutID = setTimeout(function() {
                    lt.captureMouse = !1,
                    lt.bustClick = !1
                }
                , 400)
        ...
        ,
        ht = /([^ ]+)/g,
        mt.applyEventMap = function(e, t) {
            return e = e.replace(ht, dt),
            t && (e = e.replace(ht, "$1." + t)),
            e
        }
        ,
        ut = e.fn.on,
        vt(!0, P, e),
        P.fn = P.prototype = new e,
        P.fn.constructor = P,
        P.fn.init = function(t, n) {
            return n && n instanceof e && !(n instanceof P) && (n = P(n)),
            e.fn.init.call(this, t, n, ft)
        }
        ,
        ...
        vt(P.fn, {
            ...
            autoApplyNS: function(e) {
                return this.data("kendoNS", e || mt.guid()),
                this
            },
            on: function() {
                ...
                t = Ot.call(arguments),
                typeof t[t.length - 1] === Lt && t.pop(),
                n = t[t.length - 1],
                i = mt.applyEventMap(t[0], s),
                Ct.mouseAndTouchPresent && i.search(/mouse|click/) > -1 && this[0] !== document.documentElement && (lt.setupMouseMute(),
        ...
        mt.timezone = function() {
            ...
            function a(e, t, n) {
                var i, o;
                return typeof t == Mt && (t = this.offset(e, t)),
        ...
        mt.stripWhitespace = function(e) {
            ...
            if (document.createNodeIterator)
                ...
                for (n = 0; e.childNodes.length > n; n++)
                    ...
                    n--),
                    1 == i.nodeType && mt.stripWhitespace(i)
        }
        ,
        ...
        ,
        gt = [],
        mt.queueAnimation = function(e) {
            gt[gt.length] = e,
            1 === gt.length && mt.runNextAnimation()
        }
        ,
        mt.runNextAnimation = function() {
            mt.animationFrame(function() {
                gt[0] && (gt.shift()(),
                gt[0] && mt.runNextAnimation())
            }
            )
        }
        ,
        ...
        mt.compileMobileDirective = function(e, n) {
            var i = t.angular;
            return e.attr("data-" + mt.ns + "role", e[0].tagName.toLowerCase().replace("kendo-mobile-", "").replace("-", "")),
        ...
        mt.cycleForm = function(e) {
            ...
            i.on("keydown", function(e) {
                e.keyCode != mt.keys.TAB || e.shiftKey || (e.preventDefault(),
                t(n))
            }
            ),
    ...
    function(e, t) {
        ...
        function d(e, n, i, o) {
            c(e, {
                ...
                prepare: function(e, r) {
                    ...
                    a = h ? d : t !== this._startValue ? this._startValue : c ? i : o,
        ...
        C.parseEffects = function(e, t) {
            ...
            return "string" == typeof e ? T(e.split(" "), function(e, i) {
                var o = !N.test(i)
                  ...
                  , s = a[1]
                  , l = {};
                a.length > 1 && (l.direction = t && o ? ut[s].reverse : s),
                n[a[0]] = l
            }
            ) : T(e, function(e) {
                var i = this.direction;
                i && t && !N.test(e) && (this.direction = ut[i].reverse),
                n[e] = this
            }
            ),
            n
        ...
        f = C.Class.extend({
            ...
            run: function(t) {
                ...
                for (h.effects = t,
                g.then(e.proxy(h, "complete")),
                f.data("animating", !0),
                i = 0; u > i; i++)
                    for (n = t[i],
                    n.setReverse(p.reverse),
                    n.setOptions(p),
                    h.addRestoreProperties(n.restore),
                    n.prepare(m, v),
                    l = n.children(),
                    o = 0,
                    c = l.length; c > o; o++)
            ...
            animate: function(n, o, a) {
                ...
                I && "transition" in S && s ? S.transition(n, o, a) : E ? n.animate(r(o), {
                    ...
                    T(U, function(e, a) {
                        ...
                        s && (u = a == it + "y" ? 0 : +s[1],
                        f = a == it + "y" ? +s[1] : +s[2],
                        d ? (isNaN(h.right) ? isNaN(u) || D(l, {
                            left: h.left + u
                        }) : isNaN(u) || D(l, {
                            right: h.right - u
                        }),
                        isNaN(h.bottom) ? isNaN(f) || D(l, {
                            top: h.top + f
                        }) : isNaN(f) || D(l, {
                            bottom: h.bottom - f
                        })) : (isNaN(u) || D(l, {
        ...
        c("tile", {
            ...
            children: function() {
                ...
                return n && r.push(C.fx(n).slideIn(ut[o].reverse).divisor(i).setReverse(!t)),
                r
            }
        }),
        d("fade", "opacity", 1, 0),
        ...
        c("turningPage", {
            ...
            prepare: function(e, t) {
                var n = this
                  , i = n._reverse
                  , o = i ? ut[n._direction].reverse : n._direction
                  , r = y[o];
                e.zIndex = 1,
                n._clipInHalf && (e.clip = h(n._container, C.directions[o].reverse)),
                e[lt] = J,
                t[st] = ht + (i ? r.start : r.end),
                e[st] = ht + (i ? r.end : r.start)
            },
            setup: function() {
    ...
    function(e, t) {
        function n(i, r) {
            ...
            c = _.length; c > l; l++)
                ...
                "string" === h ? (u = "'{1}'",
                p = p.replace(/'/g, "''"),
                g === !0 && (d = "tolower(" + d + ")")) : u = "date" === h ? r ? "{1:yyyy-MM-ddTHH:mm:ss+00:00}" : "datetime'{1:yyyy-MM-ddTHH:mm:ss}'" : "{1}",
                i.length > 3 ? "substringof" !== i ? u = "{0}({2}," + u + ")" : (u = "{0}(" + u + ",{2})",
                "doesnotcontain" === f && (r ? (u = "{0}({2},'{1}') eq -1",
                i = "indexof") : u += " eq false")) : u = "{2} {0} " + u,
                i = o.format(u, i, p, d))),
                m.push(i);
            return i = m.join(" " + v + " "),
            m.length > 1 && (i = "(" + i + ")"),
        ...
        var n = window.kendo
          ...
          , d = c.extend({
            init: function(t) {
                ...
                p && (o(p) && (l = t.modelBase || n.data.Model,
                p.fields && a(p.fields, function(t, n) {
                    o(n) && n.field ? e.isFunction(n.field) || (n = s(n, {
                        field: u.getter(n.field)
                    })) : n = {
                        field: u.getter(n)
                    },
                    p.fields[t] = n
                ...
                c = p.id,
                c && (d = {},
                d[u.xpathToMember(c, !0)] = {
                    field: u.getter(c)
                },
                p.fields = s(d, p.fields),
                p.id = u.xpathToMember(c)),
                p = l.define(p)),
                u.model = p),
                f && ("string" == typeof f ? (f = u.getter(f),
                u.total = function(e) {
                    return parseInt(f(e), 10)
                }
                ) : "function" == typeof f && (u.total = f)),
                m && ("string" == typeof m ? (m = u.getter(m),
                u.errors = function(e) {
                    return m(e) || null
                }
                ) : "function" == typeof m && (u.errors = m)),
                _ && ("string" == typeof _ ? (_ = u.xpathToMember(_),
                u.data = function(e) {
                    var t, n = u.evaluate(e, _);
                    return n = i(n) ? n : [n],
                    u.model && p.fields ? (t = new u.model,
                    r(n, function(e) {
                        if (e) {
                            var n, i = {};
                            for (n in p.fields)
                ...
                ) : "function" == typeof _ && (u.data = _)),
                "function" == typeof g && (h = u.parse,
                u.parse = function(e) {
                    var t = g.call(u, e);
                    return h.call(u, t)
                }
    ...
    function(e, t) {
        function n(e, t, n, i) {
            return function(o) {
                ...
                t == yt && e._notifyChange && e._notifyChange(a),
                e.trigger(t, a)
            }
        }
        function i(t, n) {
        ...
        function s(e) {
            ...
            if (r)
                ...
                n = r.length; n > t; t++)
                    i = r[t],
                    o = i.operator,
                    o && typeof o === ft && (i.operator = U[o.toLowerCase()] || o),
                    s(i)
        }
        function l(e) {
            return e && !it(e) ? ((ot(e) || !e.filters) && (e = {
                logic: "and",
                filters: ot(e) ? e : [e]
            }),
            s(e),
        ...
        function u(e, t, n, i, o, r) {
            ...
            a = 0; c > a; a++)
                ...
                r[d] = r[d] || {},
                r[d][l] = r[d][l] || {},
                e[d][l] = W[l.toLowerCase()](e[d][l], n, ct.accessor(d), i, o, r[d][l])
        }
        function f(e) {
        ...
        function y(e, t, n, i, o, r) {
            return function(a) {
                return a = e(a),
                a && !it(i) && ("[object Array]" === Ot.call(a) || a instanceof Wt || (a = [a]),
                n(a, i, new t, o, r)),
                a || []
            }
        }
        ...
        function x(e, t) {
            ...
            if (t)
                ...
                i = e.length; i > n; n++)
                    o = e.at(n),
                    o.hasSubgroups ? x(o.items, t) : o.items = new jt(o.items,t)
        }
        function k(e, t) {
        ...
        function I(e, t) {
            ...
            if (e.filters)
                ...
                i = e.filters.length; i > n; n++)
                    r.filters[n] = I(e.filters[n], t);
            else
                r.field = E(t.fields, r.field);
            return r
        }
        function B(e, t) {
            var n, i, o, r, a, s = [];
            ...
            i = e.length; i > n; n++) {
                ...
                for (a in r)
                    o[a] = r[a];
                o.field = E(t.fields, o.field),
                o.aggregates && ot(o.aggregates) && (o.aggregates = B(o.aggregates, t)),
                s.push(o)
            }
            return s
        }
        function z(t, n) {
            ...
            l = i.length; l > s; s++)
                ...
                c = d.parentNode,
                c === t && (c = null ),
                d.disabled || c && c.disabled || (c && (h.optgroup = c.label),
                h[o.field] = d.text,
                u = d.attributes.value,
                u = u && u.specified ? d.value : d.text,
                h[r.field] = u,
                a.push(h));
            return a
        }
        ...
        function F(e) {
            return function() {
                var t = this._data
                  , n = Y.fn[e].apply(this, Ft.call(arguments));
        ...
        function R(t, n) {
            ...
            r = u.length; r > o; o++)
                ...
                l = s.attr("data-id"),
                l && (a.id = l),
                c && (a[p] = 3 == c.nodeType ? c.nodeValue : h.text()),
                g && (a[g] = i(h, "a").attr("href")),
                v && (a[v] = i(h, "img").attr("src")),
                m && (d = i(h, ".k-sprite").prop("className"),
                a[m] = d && e.trim(d.replace("k-sprite", ""))),
                t.length && (a.items = R(t.eq(0), n)),
        ...
        , At = ct.getter, Pt = ct.stringify, Mt = Math, Et = [].push, It = [].join, Bt = [].pop, zt = [].splice, Lt = [].shift, Ft = [].slice, Rt = [].unshift, Ot = {}.toString, Ht = ct.support.stableSort, Nt = /^\/Date\((.*?)\)\/$/, Vt = /(\r+|\n+)/g, Ut = /(?=['\\])/g, Wt = ht.extend({
            ...
            wrap: function(e, t) {
                var n, i = this;
                return null  !== e && "[object Object]" === Ot.call(e) && (n = e instanceof i.type || e instanceof Yt,
                n || (e = e instanceof Gt ? e.toJSON() : e,
                e = new i.type(e)),
                e.parent = t,
            ...
            splice: function(e, t, n) {
                ...
                if (i = zt.apply(this, [e, t].concat(a)),
                i.length)
                    for (this.trigger(yt, {
                        action: "remove",
                        index: e,
                    ...
                    o = 0,
                    r = i.length; r > o; o++)
                        i[o] && i[o].children && i[o].unbind(yt);
                return n && this.trigger(yt, {
                    action: "add",
                    index: e,
                    items: a
                }),
            ...
            reduce: function(e) {
                ...
                for (2 == arguments.length ? t = arguments[1] : i > n && (t = this[n++]); i > n; n++)
                    t = e(t, this[n], n, this);
                return t
            },
            ...
            toJSON: function() {
                ...
                for (t in this)
                    ...
                    (e instanceof Gt || e instanceof Wt) && (e = e.toJSON()),
                    n[t] = e);
                return n
            },
            get: function(e) {
            ...
            set: function(e, t) {
                ...
                (!n._set(e, t) || e.indexOf("(") >= 0 || e.indexOf("[") >= 0) && n.trigger(yt, {
                    field: e
                })))
            },
            parent: lt,
            wrap: function(e, t, i) {
                ...
                return null  == e || "[object Object]" !== s && "[object Array]" !== s || (o = e instanceof Wt,
                r = e instanceof Y,
                "[object Object]" !== s || r || o ? ("[object Array]" === s || o || r) && (o || r || (e = new Wt(e)),
                e.parent() != i() && e.bind(yt, n(a, yt, t, !1))) : (e instanceof Gt || (e = new Gt(e)),
                e.parent() != i() && (e.bind(bt, n(a, bt, t, !0)),
                e.bind(yt, n(a, yt, t, !0)))),
                e.parent = i),
                e
            }
        }), qt = {
            ...
            _parse: function(e, t) {
                ...
                e || (e = o(a, r)),
                e && (n = e.parse,
                !n && e.type && (n = qt[e.type.toLowerCase()])),
                n ? n(t) : t
            },
        ...
        Yt.define = function(e, n) {
            n === t && (n = e,
            e = Yt);
            var i, o, r, a, s, l, c, d, h = et({
                defaults: {}
            }, n), u = {}, f = h.id, p = [];
            if (f && (h.idField = f),
            h.id && delete h.id,
            f && (h.defaults[f] = h._defaultId = ""),
            "[object Array]" === Ot.call(h.fields)) {
                for (l = 0,
                c = h.fields.length; c > l; l++)
                    r = h.fields[l],
                    typeof r === ft ? u[r] = {} : r.field && (u[r.field] = r);
                h.fields = u
            }
            for (o in h.fields)
                r = h.fields[o],
                ...
                s = null ,
                d = o,
                o = typeof r.field === ft ? r.field : o,
                r.nullable || (s = h.defaults[d !== o ? d : o] = r.defaultValue !== t ? r.defaultValue : $t[a.toLowerCase()],
                "function" == typeof s && p.push(o)),
                n.id === o && (h._defaultId = s),
                h.defaults[d !== o ? d : o] = s,
                r.parse = r.parse || qt[a];
            return p.length > 0 && (h._initializers = p),
            i = e.extend(h),
            i.define = function(e) {
                return Yt.define(i, e)
            }
            ,
            h.fields && (i.fields = h.fields,
            i.idField = h.idField),
            i
        }
        ,
        ...
        V = function() {
            ...
            function t(t, n, i, o) {
                var r;
                return null  != i && (typeof i === ft && (i = e(i),
                r = Nt.exec(i),
        ...
        r.filterExpr = function(e) {
            ...
            i = f.length; i > n; n++)
                ...
                u.push.apply(u, a.operators),
                h.push.apply(h, a.fields)) : (typeof s === pt ? (a = "__f[" + h.length + "](d)",
                h.push(s)) : a = ct.expr(s),
                typeof l === pt ? (o = "__o[" + u.length + "](" + a + ", " + V.quote(o.value) + ")",
                u.push(l)) : o = V[(l || "eq").toLowerCase()](a, o.value, o.ignoreCase !== t ? o.ignoreCase : !0)),
                c.push(o);
            return {
        ...
        r.prototype = {
            ...
            _sortForGrouping: function(e, t) {
                ...
                if (!Ht) {
                    ...
                    i = o.length; i > n; n++)
                        o[n].__position = n;
                    for (o = new r(o).sort(e, t, N).toArray(),
                    n = 0,
                    i = o.length; i > n; n++)
        ...
        r.process = function(e, n) {
            ...
            return h && (o = o.filter(h),
            c && (o = c(o)),
            i = o.toArray().length),
            l && (o = o.sort(l),
            s && (e = o.toArray())),
            u !== t && f !== t && (o = o.range(u, f)),
            s && (o = o.group(s, e)),
            {
                total: i,
                data: o.toArray()
        ...
        G = ut.extend({
            init: function(e) {
                ...
                t = e.parameterMap,
                dt(e.push) && (n.push = e.push),
                n.push || (n.push = Dt),
                n.parameterMap = dt(t) ? t : function(e) {
                    var n = {};
        ...
        $ = ut.extend({
            init: function(e) {
                ...
                for (t in e)
                    n = e[t],
                    p[t] = typeof n === ft ? At(n) : n;
                o = e.modelBase || Yt,
                nt(p.model) && (p.model = i = o.define(p.model)),
                r = tt(p.data, p),
                p._dataAccessFunction = r,
                p.model && (a = tt(p.groups, p),
                s = tt(p.serialize, p),
                l = {},
                c = {},
                d = {},
                ...
                u = !1,
                i = p.model,
                i.fields && (st(i.fields, function(e, t) {
                    var n;
                    f = e,
                    nt(t) && t.field ? f = t.field : typeof t === ft && (f = t),
                    nt(t) && t.from && (n = t.from),
                    u = u || n && n !== e || f !== e,
                    c[e] = At(n || f),
                    d[e] = At(e),
                    l[n || f] = e,
                ...
                !e.serialize && u && (p.serialize = y(s, i, m, d, l, h))),
                p._dataAccessFunction = r,
                p.data = y(r, i, v, c, l, h),
                p.groups = y(a, i, _, c, l, h))
            },
            errors: function(e) {
                return e ? e.errors : null
            },
        ...
        Y = ht.extend({
            init: function(e) {
                ...
                ht.fn.init.call(r),
                r.transport = Q.create(e, i, r),
                dt(r.transport.push) && r.transport.push({
                ...
                r.reader = new ct.data.readers[e.schema.type || "json"](e.schema),
                n = r.reader.model || {},
                r._detachObservableParents(),
                r._data = r._observe(r._data),
                r._online = !0,
                r.bind(["push", xt, yt, kt, wt, St, Ct], e)
            },
            options: {
                data: null ,
                schema: {
            ...
            _observeView: function(e) {
                var t, n = this;
                return T(e, n._data, n._ranges, n.reader.model || Gt, n._isServerGrouped()),
                t = new jt(e,n.reader.model),
                t.parent = function() {
                    return n.parent()
                }
                ,
            ...
            insert: function(e, t) {
                return t || (t = e,
                e = 0),
                t instanceof Yt || (t = this._createNewModel(t)),
            ...
            sync: function() {
                var t, n = this, i = [], o = [], r = n._destroyed, a = (n._flatData(n._data),
                ...
                if (n.online()) {
                    ...
                    o = n.updated(),
                    t = [],
                    n.options.batch && n.transport.submit ? t = n._sendSubmit(i, o, r) : (t.push.apply(t, n._send("create", i)),
                    t.push.apply(t, n._send("update", o)),
                    t.push.apply(t, n._send("destroy", r))),
                    a = e.when.apply(null , t).then(function() {
                        var e, t;
                        for (e = 0,
                        t = arguments.length; t > e; e++)
                            n._accept(arguments[e]);
                        n._storeData(!0),
                        n._change({
                            action: "sync"
                        }),
            ...
            cancelChanges: function(e) {
                var t = this;
                e instanceof ct.data.Model ? t._cancelModel(e) : (t._destroyed = [],
            ...
            _accept: function(t) {
                ...
                n = o.length; n > a; a++)
                    ...
                    "create" === c ? l.push(s ? i._wrapInEmptyGroup(o[a]) : r[a]) : "update" === c && i._updatePristineForModel(o[a], r[a])) : i._removePristineForModel(o[a])
            },
            ...
            _promise: function(t, n, i) {
                ...
                return e.Deferred(function(e) {
                    ...
                    o.transport[i].call(o.transport, et({
                        success: function(t) {
                            e.resolve({
                                response: t,
                                models: n,
            ...
            success: function(e) {
                ...
                d.online()) {
                    if (e = d.reader.parse(e),
                    d._handleCustomErrors(e))
                        return d._dequeueRequest(),
                        t;
                    d._total = d.reader.total(e),
                    d._aggregate && h.serverAggregates && (d._aggregateResult = d._readAggregates(e)),
                    e = d._readData(e)
                } else {
                    for (e = d._readData(e),
                    n = [],
                    ...
                    o = d.reader.model,
                    r = o ? o.idField : "id",
                    a = 0; this._destroyed.length > a; a++)
                        s = this._destroyed[a][r],
                        i[s] = s;
                    for (a = 0; e.length > a; a++)
                        l = e[a],
                        c = l.__state__,
                        "destroy" == c ? i[l[r]] || this._destroyed.push(this._createNewModel(l)) : n.push(l);
                    e = n,
                    d._total = e.length
                }
                d._pristineTotal = d._total,
                d._pristineData = e.slice(0),
                d._detachObservableParents(),
                d._data = d._observe(e),
                null  != d.options.offlineStorage && d._eachItem(d._data, function(e) {
                    var t, n;
            ...
            _detachObservableParents: function() {
                if (this._data && this._shouldDetachObservableParents)
                    for (var e = 0; this._data.length > e; e++)
                        this._data[e].parent && (this._data[e].parent = lt)
            },
            ...
            _params: function(e) {
                ...
                t.options.serverFiltering ? t.reader.model && n.filter && (n.filter = I(n.filter, t.reader.model)) : delete n.filter,
            ...
            _observe: function(e) {
                ...
                e instanceof Wt ? (n._shouldDetachObservableParents = !1,
                n._shouldWrap(e) && (e.type = n.reader.model,
                e.wrapAll(e, e))) : (t = n.pageSize() && !n.options.serverPaging ? jt : Wt,
                ...
                n._changeHandler && n._data && n._data instanceof Wt ? n._data.unbind(yt, n._changeHandler) : n._changeHandler = tt(n._change, n),
                e.bind(yt, n._changeHandler)
            },
            _change: function(e) {
            ...
            query: function(n) {
                ...
                return r || (this._data === t || 0 === this._data.length) && !this._destroyed.length ? this.read(this._mergeState(n)) : (o = this.trigger(kt, {
                    type: "read"
                }),
                o || (this.trigger(Ct),
            ...
            page: function(e) {
                var n, i = this;
                return e !== t ? (e = Mt.max(Mt.min(Mt.max(e, 1), i.totalPages()), 1),
                i._query({
                    page: e
                }),
                t) : (n = i.skip(),
                n !== t ? Mt.round((n || 0) / (i.take() || 1)) + 1 : t)
            },
            pageSize: function(e) {
                var n = this;
                return e !== t ? (n._query({
            ...
            aggregates: function() {
                ...
                return it(e) && (e = this._emptyAggregates(this.aggregate())),
                e
            },
            ...
            range: function(e, n) {
                ...
                e = Mt.min(e || 0, this.total()),
                i = this,
                o = Mt.max(Mt.floor(e / n), 0) * n,
                r = Mt.min(o + n, i.total()),
                a = i._findRange(e, Mt.min(e + n, i.total())),
                a.length) {
                    i._pending = t,
                    i._skip = e > i.skip() ? Mt.min(r, (i.totalPages() - 1) * i.take()) : o,
                    i._take = n,
            ...
            _prefetchSuccessHandler: function(e, t, n, i) {
                ...
                return function(a) {
                    ...
                    h.data = o._observe(c),
                    h.end = h.start + o._flatData(h.data, !0).length,
                    o._ranges.sort(function(e, t) {
                        return e.start - t.start
                    }
                    ),
                    o._total = o.reader.total(a),
                    (i || r >= o._currentRequestTimeStamp || !o._skipRequestsInProgress) && (n && c.length ? n() : o.trigger(yt, {}))
                }
            },
            prefetch: function(e, t, n) {
                var i = this
                  , o = Mt.min(e + t, i.total())
                  , r = {
                    take: t,
                    skip: e,
                    page: e / t + 1,
            ...
            _multiplePrefetch: function(e, t, n) {
                ...
                i._rangeExists(e, o) ? n && n() : i.trigger(kt, {
                    type: "read"
                }) || i.transport.read({
                    data: i._params(r),
        ...
        Q.create = function(e, t, n) {
            var i, o = e.transport;
            return o ? (o.read = typeof o.read === ft ? {
                url: o.read
            } : o.read,
            n && (o.dataSource = n),
            e.type && (ct.data.transports = ct.data.transports || {},
            ct.data.schemas = ct.data.schemas || {},
            ct.data.transports[e.type] && !nt(ct.data.transports[e.type]) ? i = new ct.data.transports[e.type](et(o, {
                data: t
            })) : o = et(!0, {}, ct.data.transports[e.type], o),
            e.schema = et(!0, {}, ct.data.schemas[e.type], e.schema)),
            i || (i = dt(o.read) ? o : new G(o))) : i = new j({
                data: e.data || []
            }),
            i
        }
        ,
        Y.create = function(e) {
            (ot(e) || e instanceof Wt) && (e = {
                data: e
            });
            var n, i, o, r = e || {}, a = r.data, s = r.fields, l = r.table, c = r.select, d = {};
            if (a || !s || r.transport || (l ? a = L(l, s) : c && (a = z(c, s),
            r.group === t && a[0] && a[0].optgroup !== t && (r.group = "optgroup"))),
            ct.data.Model && s && (!r.schema || !r.schema.model)) {
                for (n = 0,
                i = s.length; i > n; n++)
                    o = s[n],
                    o.type && (d[o.field] = o);
                it(d) || (r.schema = et(!0, r.schema, {
                    model: {
                        fields: d
                    }
                }))
        ...
        X = Yt.define({
            ...
            init: function(e) {
                var t = this
                  ...
                  , i = "items"
                  , o = {};
                ct.data.Model.fn.init.call(t, e),
                typeof t.children === ft && (i = t.children),
                o = {
                    schema: {
                        data: i,
                        model: {
                ...
                typeof t.children !== ft && et(o, t.children),
                o.data = e,
                n || (n = o.schema.data),
                typeof n === ft && (n = ct.getter(n)),
                dt(n) && (t.hasChildren = !!n.call(t, t)),
            ...
            load: function() {
                ...
                r = "read"),
                n.one(yt, tt(this._childrenLoaded, this)),
        ...
        K = Y.extend({
            ...
            insert: function(e, t) {
                ...
                n._initChildren()),
                Y.fn.insert.call(this, e, t)
            },
            _find: function(e, t) {
                var n, i, o, r, a;
                if (o = Y.fn[e].call(this, t))
                    return o;
                if (r = this._flatData(this._data))
                    for (n = 0,
                    i = r.length; i > n; n++)
                        if (a = r[n].children,
                        a instanceof K && (o = a[e](t)))
                            return o
            },
            get: function(e) {
        ...
        K.create = function(e) {
            ...
            var t = e || {}
              ...
              , i = t.fields
              , o = t.list;
            return n && n._dataSource ? n._dataSource : (n || !i || t.transport || o && (n = R(o, i)),
            t.data = n,
        ...
        Z = ct.Observable.extend({
            init: function(e, t, n) {
                ct.Observable.fn.init.call(this),
                this._prefetching = !1,
                this.dataSource = e,
                this.prefetch = !n;
                var i = this;
        ...
        J = ct.Observable.extend({
            init: function(e, t) {
                var n = this;
                ct.Observable.fn.init.call(n),
                this.dataSource = e,
                this.batchSize = t,
                this._total = 0,
                this.buffer = new Z(e,3 * t),
                this.buffer.bind({
    ...
    function(e, t) {
        function n(t, n, i) {
            return v.extend({
                ...
                dataBound: function(e) {
                    var i, o, r, s, l = this.widget, c = e.addedItems || l.items(), d = l[n], h = (d.group() || [],
                    C.data.HierarchicalDataSource);
                    if (!(h && d instanceof h) && c.length)
                ...
                refresh: function(e) {
                    ...
                    r.bindings.value && (a instanceof C.ui.Select || a instanceof C.ui.MultiSelect) && a.value(f(r.bindings.value.get(), a.options.dataValueField)))))
                },
                destroy: function() {
                    var e = this.widget;
        ...
        function a(e, t, n, s) {
            ...
            f.css && (d.css = r(f.css, s, p)),
            h.bind(d)),
            h && (e.kendoBindingTarget = h),
            y && v) {
        ...
        function l(e) {
            ...
            t && (t.destroy(),
            R ? delete e.kendoBindingTarget : e.removeAttribute ? e.removeAttribute("kendoBindingTarget") : e.kendoBindingTarget = null )
        }
        function c(e) {
            l(e),
            d(e)
        ...
        function f(e, t) {
            ...
            if (e instanceof D) {
                for (n = e.length; n > r; r++)
                    i = e[r],
                    o[r] = i.get ? i.get(t) : i[t];
                e = o
            } else
                e instanceof T && (e = e.get(t));
            return e
        }
        ...
        p = S.extend({
            ...
            get: function() {
                ...
                n.unbind(O, e._change).bind(O, e._change)),
                e.stop(e.source),
                r
            },
            set: function(e) {
            ...
            destroy: function() {
                this.observable && (this.source.unbind(O, this._change),
                this.currentSource && this.currentSource.unbind(O, this._change)),
                this.unbind()
            }
        }),
        g = p.extend({
        ...
        P.value = _.extend({
            init: function(t, n, i) {
                ...
                this.eventName = i.valueUpdate || O,
                e(this.element).on(this.eventName, this._change),
                this._initChange = !1
            },
            change: function() {
                this._initChange = this.eventName != O,
        ...
        P.select = {
            source: P.source.extend({
                refresh: function(n) {
                    var i = this
                      , o = i.bindings.source.get();
                    o instanceof D || o instanceof C.data.DataSource ? (n = n || {},
                    "add" == n.action ? i.add(n.index, n.items) : "remove" == n.action ? i.remove(n.index, n.items) : ("itemchange" == n.action || n.action === t) && (i.render(),
                    i.bindings.value && i.bindings.value && (i.element.value = f(i.bindings.value.get(), e(i.element).data("valueField"))))) : i.render()
                }
            }),
            value: _.extend({
                init: function(t, n, i) {
        ...
        P.widget = {
            ...
            checked: v.extend({
                init: function(e, t, n) {
                    ...
                    this.widget = e,
                    this._change = E(this.change, this),
                    this.widget.bind(O, this._change)
                },
                change: function() {
            ...
            value: v.extend({
                init: function(t, n, i) {
                    ...
                    this.widget.first(O, this._change);
                ...
                refresh: function() {
                    ...
                    if (!this._initChange) {
                        ...
                        o)
                            if (r instanceof D) {
                                for (l = r.length; l > s; s++)
                                    c[s] = r[s].get(o);
                                r = c
                            } else
                                r instanceof T && (a = r.get(i),
                                r = r.get(o));
                        n.autoBind !== !1 || n.cascadeFrom || !e.listView || e.listView.isBound() ? e.value(r) : (i !== o || a || (a = r),
                        !a && r && n.valuePrimitive ? e.value(r) : e._preselect(r, a))
                    }
                    this._initChange = !1
                },
                destroy: function() {
                ...
                value: v.extend({
                    ...
                    refresh: function() {
                        if (!this._initChange) {
                            ...
                            r)
                                if (a instanceof D) {
                                    for (e = a.length; e > l; l++)
                                        n = a[l],
                                        c[l] = n.get ? n.get(r) : n;
                                    a = c
                                } else
                                    a instanceof T && (a = a.get(r));
        ...
        w = M.extend({
            ...
            bind: function(e) {
                ...
                for (t in e)
                    t == I ? n = !0 : t == B ? i = !0 : t != z || s ? t == L ? r = !0 : t == F ? a = !0 : this.applyBinding(t, e, l) : o = !0;
                i && this.applyBinding(B, e, l),
                n && this.applyBinding(I, e, l),
                r && this.applyBinding(L, e, l),
                o && !s && this.applyBinding(z, e, l),
                a && !s && this.applyBinding(F, e, l)
            },
            binders: function() {
    ...
    function(e) {
        ...
        function r(t, n) {
            ...
            a = t.length; a > r; r++)
                i = t[r],
                h.test(i.className) && (o = i.getAttribute(s.attr("for")),
                o === n && (l = l.add(i)));
            return l
        }
        ...
        a = l.extend({
            ...
            validateInput: function(t) {
                ...
                c = "." + d,
                h = t.attr(w) || "",
                p = i._findMessageContainer(h).add(t.next(c).filter(function() {
                    var t = e(this);
                    return t.filter("[" + s.attr("for") + "]").length ? t.attr(s.attr("for")) === h : !0
                }
                )).hide(),
                t.removeAttr("aria-invalid"),
                l ? delete i._errors[h] : (g = i._extractMessage(t, a.key),
                i._errors[h] = g,
                m = o(r({
                    message: n(g)
                })),
                v = p.attr("id"),
                i._decorateMessageContainer(m, h),
                v && m.attr("id", v),
        ...
        var l = window.kendo
          ...
          , x = l.Observable.extend({
            ...
            _navigate: function(e, n, i) {
                ...
                this.current === e || this.current === decodeURIComponent(e) ? (this.trigger(h),
                t) : ((n || !this.trigger(c, {
                    url: e
                })) && (this.current = e,
                i.call(this, o),
        ...
        var n = window.kendo
          ...
          , _ = i.extend({
            ...
            show: function(e, i, o) {
                ...
                e.showStart(),
                c && !i && (h.reverse = !h.reverse),
                r.effect = n.fx(e.element).replace(a.element, h.type).beforeTransition(function() {
                ...
                ).direction(h.direction).setReverse(h.reverse),
        ...
        var o = window.kendo
          ...
          , I = l.extend({
            init: function(t, n) {
                ...
                n = n || {},
                s = u.filter = n.filter,
                u.threshold = n.threshold || p,
                u.minHold = n.minHold || f,
                u.touches = [],
                u._maxTouches = n.multiTouch ? 2 : 1,
                u.allowSelection = n.allowSelection,
                u.captureUpIfMoved = n.captureUpIfMoved,
                u.eventNS = A,
                t = e(t).handler(u),
                l.fn.init.call(u),
                d(u, {
                ...
                u.surface.handler(u).on(o.applyEventMap("move", A), "_move").on(o.applyEventMap("up cancel", A), "_end"),
                ...
                u.captureUpIfMoved && r.eventCapture && (c = u.surface[0],
                h = e.proxy(u.preventIfMoving, u),
                i(function(e) {
    ...
    function(e, t) {
        ...
        function a(n, i, o) {
            for (var r, a, s = 0, l = i && i.length, c = o && o.length; n && n.parentNode; ) {
                ...
                for (s = 0; c > s; s++)
                    if (a = o[s],
                    e.contains(a.element[0], n) && y.matchesSelector.call(n, a.options.filter))
                        return {
                            target: a,
                            targetElement: n
                        };
        ...
        function d(t) {
            if (!t || c(t))
                return e(w.body);
            for (var n = e(t)[0]; !_.isScrollable(n) && !c(n); )
                n = n.parentNode;
            return e(n)
        }
        function h(e, t, n) {
            var i = {
              ...
              , o = 50;
            return o > e - n.left ? i.x = -(o - (e - n.left)) : o > n.right - e && (i.x = o - (n.right - e)),
            o > t - n.top ? i.y = -(o - (t - n.top)) : o > n.bottom - t && (i.y = o - (n.bottom - t)),
            i
        }
        var u, f, p, g, m, v, _ = window.kendo, y = _.support, w = window.document, b = e(window), x = _.Class, k = _.ui.Widget, C = _.Observable, S = _.UserEvents, T = e.proxy, D = e.extend, A = _.getOffset, P = {}, M = {}, E = {}, I = _.elementUnderCursor, B = "keyup", z = "change", L = "dragstart", F = "hold", R = "drag", O = "dragend", H = "dragcancel", N = "hintDestroyed", V = "dragenter", U = "dragleave", W = "drop", j = C.extend({
            init: function(t, n) {
                var i = this
                  , o = t[0];
                i.capture = !1,
                o.addEventListener ? (e.each(_.eventMap.down.split(" "), function() {
            ...
            init: function(e) {
                ...
                r.userEvents.bind(["move", "end", "gesturestart", "gesturechange"], {
                    ...
                    gesturechange: function(e) {
                        ...
                        u >= o.scale && 1 > h && (h += .8 * (1 - h)),
                        o.scale * h >= f && (h = f / o.scale),
                        a = o.x + r.offset.left,
                        s = o.y + r.offset.top,
                        i = {
                            x: (a - c.x) * h + d.x - a,
        ...
        p = C.extend({
            init: function(t) {
                ...
                n.y = 0,
                n.scale = 1,
                n._saveCoordinates(f(n.x, n.y, n.scale))
            },
            ...
            refresh: function() {
                ...
                i = Math.round(i)),
                e = f(n, i, t.scale),
                e != t.coordinates && (_.support.browser.msie && 10 > _.support.browser.version ? (t.element[0].style.position = "absolute",
                t.element[0].style.left = t.x + "px",
                t.element[0].style.top = t.y + "px") : t.element[0].style[Q] = e,
        ...
        g = k.extend({
            init: function(e, t) {
                var n, i = this;
                k.fn.init.call(i, e, t),
                n = i.options.group,
                n in M ? M[n].push(i) : M[n] = [i]
            },
            events: [V, U, W],
            options: {
                name: "DropTarget",
            ...
            _trigger: function(e, n) {
                var i = this
                  , o = P[i.options.group];
                return o ? i.trigger(e, D({}, n.event, {
                    draggable: o,
        ...
        v = k.extend({
            init: function(e, t) {
                var n = this;
                k.fn.init.call(n, e, t),
                n._activated = !1,
                n.userEvents = new S(n.element,{
                    global: !0,
                    allowSelection: !0,
                ...
                n._afterEndHandler = T(n._afterEnd, n),
                n._captureEscape = T(n._captureEscape, n)
            },
            events: [F, L, R, O, H, N],
            options: {
                name: "Draggable",
            ...
            _captureEscape: function(e) {
                var t = this;
                e.keyCode === _.keys.ESC && (t._trigger(H, {
                    event: e
                }),
                t.userEvents.cancel())
            },
            ...
            _start: function(n) {
                ...
                o.currentTargetOffset = A(o.currentTarget),
                l && (o.hint && o.hint.stop(!0, !0).remove(),
                o.hint = _.isFunction(l) ? e(l.call(o, o.currentTarget)) : l,
                i = A(o.currentTarget),
                o.hintOffset = i,
                o.hint.css({
                    position: "absolute",
                ...
                o._trigger(L, n) && (o.userEvents.cancel(),
                o._afterEnd()),
                o.userEvents.capture(),
                e(w).on(B, o._captureEscape),
                t)
            },
            _hold: function(e) {
                this.currentTarget = e.target,
                this._trigger(F, e) ? this.userEvents.cancel() : this._activated = !0
            },
            _drag: function(n) {
                var i, o, r = this;
                n.preventDefault(),
                i = this._elementUnderCursor(n),
                r._withDropTarget(i, function(i, o) {
                    if (!i)
                        return u && (u._trigger(U, D(n, {
                            dropTarget: e(u.targetElement)
                        })),
                        u = null ),
                        t;
                    if (u) {
                        if (o === u.targetElement)
                            return;
                        u._trigger(U, D(n, {
                            dropTarget: e(u.targetElement)
                        }))
                ...
                this.options.autoScroll && (this._cursorElement !== i && (this._scrollableParent = d(i),
                this._cursorElement = i),
                this._scrollableParent[0] && (o = h(n.x.location, n.y.location, l(this._scrollableParent)),
                this._scrollCompenstation = e.extend({}, this.hintOffset),
                this._scrollVelocity = o,
                0 === o.y && 0 === o.x ? (clearInterval(this._scrollInterval),
                this._scrollInterval = null ) : this._scrollInterval || (this._scrollInterval = setInterval(e.proxy(this, "_autoScroll"), 50)))),
                r.hint && r._updateHint(n)
            },
            _autoScroll: function() {
                var e, t, n, i, o, r, a, s = this._scrollableParent[0], l = this._scrollVelocity, c = this._scrollCompenstation;
                s && (n = s === w.body,
                n ? (e = w.body.offsetHeight > b.height(),
                t = w.body.offsetWidth > b.width()) : (e = s.scrollHeight >= s.offsetHeight,
                t = s.scrollWidth >= s.offsetWidth),
                i = s.scrollTop + l.y,
                o = e && i > 0 && s.scrollHeight > i,
                r = s.scrollLeft + l.x,
                a = t && r > 0 && s.scrollWidth > r,
                o && (s.scrollTop += l.y),
                a && (s.scrollLeft += l.x),
                n && (a || o) && (o && (c.top += l.y),
                a && (c.left += l.x),
            ...
            _withDropTarget: function(e, t) {
                ...
                (o && o.length || r && r.length) && (n = a(e, o, r),
                n ? t(n.target, n.targetElement) : t())
            },
            destroy: function() {
                var e = this;
                k.fn.destroy.call(e),
            ...
            _afterEnd: function() {
                ...
                delete P[t.options.group],
                t.trigger("destroy"),
                t.trigger(N),
                e(w).off(B, t._captureEscape)
            }
        }),
        _.ui.plugin(g),
        _.ui.plugin(m),
          ...
          , R = o.extend({
            ...
            open: function(t, i) {
                var o, a, l, c = this, d = {
                    ...
                    x: t,
                    y: i
                }, h = c.element, u = c.options, f = "down", g = e(u.anchor), y = h[0] && h.hasClass("km-widget");
                if (!c.visible()) {
                    if (u.copyAnchorStyles && (y && "font-size" == F[0] && F.shift(),
                    h.css(n.getComputedStyles(g[0], F))),
                    h.data("animating") || c._trigger(s))
                        return;
                    c._activated = !1,
                    u.modal || (A.unbind(c.downEvent, c._mousedownProxy).bind(c.downEvent, c._mousedownProxy),
                    ...
                    c.wrapper = a = n.wrap(h, u.autosize).css({
                        overflow: v,
                        display: "block",
                        position: m
                    }),
            ...
            _mousedown: function(i) {
                var o = this
                  ...
                  , h = d.parent().parent(".km-shim").length;
                d = d[0],
                (h || !d || d === o.element[0]) && "popover" !== e(i.target).closest("a").data("rel") && (t(r, c) || t(s, c) || l && t(e(l)[0], c) || o.close())
            },
            _fit: function(e, t, n) {
                var i = 0;
            ...
            _position: function(t) {
                var i, o, s, l, c, d, h, u, f, p, g, v = this, _ = v.element, b = v.wrapper, x = v.options, k = e(x.viewport), C = k.offset(), S = e(x.anchor), T = x.origin.toLowerCase().split(" "), D = x.position.toLowerCase().split(" "), A = v.collisions, P = r.zoomLevel(), M = 10002, E = !!(k[0] == window && window.innerWidth && 1.02 >= P), I = 0, B = document.documentElement, L = E ? window.innerWidth : k.width(), F = E ? window.innerHeight : k.height();
                if (E && B.scrollHeight - B.clientHeight > 0 && (L -= n.support.scrollbar()),
                i = S.parents().filter(b.siblings()),
                i[0])
                    if (s = Math.max(+i.css("zIndex"), 0))
                        M = s + 10;
                    else
                        for (o = S.parentsUntil(i),
                        l = o.length; l > I; I++)
                            s = +e(o[I]).css("zIndex"),
                            s && s > M && (M = s + 10);
                return b.css("zIndex", M),
                b.css(t && t.isFixed ? {
                    left: t.x,
                    top: t.y
                } : v._align(T, D)),
                c = a(b, w, S[0] === b.offsetParent()[0]),
                d = a(b),
                h = S.offsetParent().parent(".k-animation-container,.k-popup,.k-group"),
                h.length && (c = a(b, w, !0),
                d = a(b)),
                k[0] === window ? (d.top -= window.pageYOffset || document.documentElement.scrollTop || 0,
                d.left -= window.pageXOffset || document.documentElement.scrollLeft || 0) : (d.top -= C.top,
                d.left -= C.left),
                v.wrapper.data(y) || b.data(y, z({}, c)),
                u = z({}, d),
                f = z({}, c),
                p = x.adjustSize,
                "fit" === A[0] && (f.top += v._fit(u.top, b.outerHeight() + p.height, F / P)),
                "fit" === A[1] && (f.left += v._fit(u.left, b.outerWidth() + p.width, L / P)),
                g = z({}, f),
                "flip" === A[0] && (f.top += v._flip(u.top, _.outerHeight(), S.outerHeight(), F / P, T[0], D[0], b.outerHeight())),
                "flip" === A[1] && (f.left += v._flip(u.left, _.outerWidth(), S.outerWidth(), L / P, T[1], D[1], b.outerWidth())),
                _.css(w, m),
                b.css(f),
                f.left != g.left || f.top != g.top
            },
            _align: function(t, n) {
                var i, o = this, r = o.wrapper, s = e(o.options.anchor), l = t[0], c = t[1], d = n[0], u = n[1], p = a(s), m = e(o.options.appendTo), v = r.outerWidth(), _ = r.outerHeight(), y = s.outerWidth(), w = s.outerHeight(), b = p.top, x = p.left, k = Math.round;
    ...
    function(e, t) {
        ...
        var r = window.kendo
          ...
          , d = r.ViewClone
          , h = "init"
          , u = '<div style="height: 100%; width: 100%; position: absolute; top: 0; left: 0; z-index: 20000; display: none" />'
          , f = "beforeShow"
          , p = "show"
          , g = "afterShow"
          , m = "beforeHide"
        ...
        var n = window.kendo
          ...
          , b = a.extend({
            ...
            _setupAppLinks: function() {
                var t = this
                  , i = "tab"
                  , r = "[data-" + n.ns + "navigate-on-press]"
                  , a = e.map(["button", "backbutton", "detailbutton", "listview-link"], function(e) {
                    return o(e) + ":not(" + r + ")"
                }
                ).join(",");
                this.element.handler(this).on("down", o(i) + "," + r, "_mouseup").on("click", o(i) + "," + a + "," + r, "_appLinkClick"),
        ...
        var t = window.kendo
          ...
          , m = h.extend({
            init: function(n, i) {
                ...
                d.popup = new t.ui.Popup(d.wrapper,e.extend(!0, r, f, u[i.direction]))
            },
            options: {
                name: "Popup",
                width: 240,
            ...
            _activate: function() {
                var t = this
                  ...
                  , c = r.flipped ? g[n] : n
                  , h = 2 * t.arrow[i.size]()
                  , u = t.element[i.size]() - t.arrow[i.size]()
                  , f = e(a)[i.size]()
                  , p = s[o] - l[o] + f / 2;
                h > p && (p = h),
                p > u && (p = u),
          ...
          , l = s.extend({
            init: function(t, i) {
                var l = this
                  ...
                  , h = c ? c.os.name : d ? d.name : "ios"
                  , u = "ios" === h || "wp" === h || (c ? c.os.skin : !1)
                  , f = "blackberry" === h
                  , p = i.align || (u ? "bottom center" : f ? "center right" : "center center")
                  , g = i.position || (u ? "bottom center" : f ? "center right" : "center center")
                  , m = i.effect || (u ? "slideIn:up" : f ? "slideIn:left" : "fade:in")
    ...
    function(e, t) {
        ...
        var l = window.kendo
          ...
          , v = "km-vertical"
          , _ = "chrome" === p.browser
          , y = p.ios && p.flatVersion >= 700 && 800 > p.flatVersion && (p.appMode || _)
          ...
          , k = l.template('<meta content="initial-scale=#: data.scale #, maximum-scale=#: data.scale #, user-scalable=no#=data.height#" name="viewport" />', {
            usedWithBlock: !1
        })
          ...
          , O = h.extend({
            ...
            _resizeToScreenHeight: function() {
                ...
                t = _ ? window.innerHeight : o(i) ? n ? w ? z.availWidth + I : z.availWidth : w ? z.availWidth : z.availWidth - I : n ? w ? z.availHeight : z.availHeight + I : w ? z.availHeight - I : z.availHeight,
                i.height(t)
            },
            _setupElementClass: function() {
                ...
                _ && i.addClass("km-ios-chrome"),
                d.wpDevicePixelRatio && i.parent().css("font-size", d.wpDevicePixelRatio + "em"),
                this.options.retina && (i.parent().addClass("km-retina"),
                i.parent().css("font-size", d.devicePixelRatio * m + "em")),
                g && s(),
                n.options.useNativeScrolling ? i.parent().addClass("km-native-scrolling") : T && (t = (screen.availWidth > screen.availHeight ? screen.availWidth : screen.availHeight) + 200,
                e(S({
                    width: t,
                    height: t
                })).appendTo(L)),
                y && n._resizeToScreenHeight(),
                l.onResize(function() {
    ...
    function(e) {
        var t = window.kendo
          ...
          , u = '<div class="km-actionsheet-wrapper" />'
        ...
        var o = window.kendo
          ...
          , p = s.extend({
            init: function(e, t) {
                ...
                r.options.enable = r.options.enable && !r.element.attr(u),
            ...
            _release: function(n) {
                var i = this;
                if (!(n.which > 1))
                    return i.options.enable ? (i.trigger(h, {
                        target: e(n.target),
                        button: i.element
                    }) && n.preventDefault(),
                    t) : (n.preventDefault(),
        ...
        var t = window.kendo
          ...
          , m = i.extend({
            init: function(n, r) {
                ...
                l.addClass(a.options.collapsed ? d : h),
            ...
            expand: function(e) {
                ...
                this.element.removeClass(d).addClass(h),
            ...
            collapse: function(e) {
                ...
                this.element.removeClass(h).addClass(d),
    ...
    function(e, t) {
        ...
        , q = m.Class.extend({
            ...
            update: function(e) {
                ...
                d ? a[0].top > h && a[a.length - 1].bottom > u + c && this.offset > 0 && (this.offset--,
                t = a.pop(),
                n = a[0],
                t.update(this.content(this.offset)),
                a.unshift(t),
                t.above(n),
                r._resize()) : u > a[a.length - 1].bottom && h - c > a[0].top && (o = this.offset + l,
        ...
        f = m.Class.extend({
            ...
            refresh: function(e) {
                ...
                return "itemchange" !== c || h._hasBindingTarget() ? (a = "add" === c && !m || f && !h._filter,
                s = "remove" === c && !m,
                a ? i = [] : s && (i = h.findByDataItem(d)),
                h.trigger(F, {
                    action: c || "rebind",
                    items: d,
                    removedItems: i,
                    index: e && e.index
                }) ? (this._shouldShowLoading() && h.hideLoading(),
                t) : ("add" !== c || m ? "remove" !== c || m ? m ? h.replaceGrouped(p) : f && !h._filter ? (o = h.prepend(p),
                r = p) : h.replace(p) : (o = [],
                h.remove(d)) : (l = p.indexOf(d[0]),
                l > -1 && (o = h.insertAt(d, l),
                r = d)),
                this._shouldShowLoading() && h.hideLoading(),
                h.trigger(L, {
                    ns: y,
                ...
                t)) : (n = h.findByDataItem(d)[0],
                n && h.setDataItem(n, d[0]),
                t)
            },
            setDataSource: function(e) {
                this.dataSource && this._unbindDataSource(),
                this.dataSource = e,
                e.bind(H, this._refreshHandler),
        ...
        g = b.extend({
            init: function(t, n) {
                var i = this;
                b.fn.init.call(this, t, n),
                t = this.element,
                n = this.options,
                n.scrollTreshold && (n.scrollThreshold = n.scrollTreshold),
                t.on("down", k, "_highlight").on("move up cancel", k, "_dim"),
                this._userEvents = new m.UserEvents(t,{
                    filter: x,
                    allowSelection: !0,
                    tap: function(e) {
                        i._click(e)
                ...
                t.css("-ms-touch-action", "auto"),
                t.wrap(E),
                this.wrapper = this.element.parent(),
                this._headerFixer = new j(this),
                this._itemsCache = {},
                this._templates(),
                this.virtual = n.endlessScroll || n.loadMore,
                this._style(),
                this.options.$angular && (this.virtual || this.options.pullToRefresh) ? setTimeout(e.proxy(this, "_start")) : this._start()
            },
            _start: function() {
                var e = this.options;
                this.options.filterable && (this._filter = new p(this)),
                this._itemBinder = this.virtual ? new u(this) : new f(this),
                this.options.pullToRefresh && (this._pullToRefreshHandler = new q(this)),
                this.setDataSource(e.dataSource),
    ...
    function(e, t) {
        ...
        a = d.Observable.extend({
            init: function(e, t, n) {
                ...
                this.pagerOverlay = n.pagerOverlay
            },
            scrollTo: function(e, t) {
                this.page = e,
            ...
            resizeTo: function(e) {
                ...
                !this.pagerOverlay && n.length && (t -= n.outerHeight(!0))),
        ...
        s = d.Observable.extend({
            ...
            resizeTo: function(e) {
                ...
                !this.options.pagerOverlay && i.length && (n -= i.outerHeight(!0))),
            ...
            paneMoved: function(e, t, n, i) {
                ...
                e === U ? 0 !== r.page && (f = -1) : e !== N || u ? l > 0 && c && !u ? f = 1 : 0 > l && c && 0 !== r.page && (f = -1) : f = 1,
                o = r.page,
                f && (o = f > 0 ? o + 1 : o - 1),
                n && n({
                    currentPage: r.page,
                ...
                0 === f ? r._cancelMove(h, i) : -1 === f ? r._moveBackward(i) : 1 === f && r._moveForward(i)
            },
            updatePage: function() {
                var e = this.pages;
        ...
        c = v.extend({
            init: function(e, t) {
                ...
                this.options.pagerOverlay && e.addClass("km-scrollview-overlay")),
        ...
        var i = window.kendo
          ...
          , v = r.extend({
            ...
            _start: function() {
                ...
                this.handle.addClass(h)) : this.userEvents.cancel()
            },
            _stop: function() {
                var e = this;
                e.handle.removeClass(h),
    ...
    function(e, t, n) {
        ...
        function h(e, t, i, o, r) {
            ...
            ,
            e.first("change", l(!1)),
            kendo.ui.AutoComplete && e instanceof kendo.ui.AutoComplete || e.first("dataBound", l(!0)),
            h = a(),
            h != o.$viewValue && (o.$isEmpty(o.$viewValue) ? null  != h && "" !== h && h != o.$viewValue && o.$setViewValue(h) : e.value(o.$viewValue)),
            o.$setPristine())
        }
        function u(t, i, o) {
            var r, a, s, l, c, d;
            return "function" != typeof t.value ? (T.warn("k-ng-model specified on a widget that does not have the value() method: " + t.options.name),
            n) : (r = e(t.element).parents("form"),
            a = i[r.attr("name")],
            s = k(o),
            l = s.assign,
            c = !1,
            t.$angular_setLogicValue(s(i)),
            d = function(e, i) {
                e === n && (e = null ),
                c || e !== i && t.$angular_setLogicValue(e)
            }
            ,
            kendo.ui.MultiSelect && t instanceof kendo.ui.MultiSelect ? i.$watchCollection(o, d) : i.$watch(o, d),
            t.first("change", function() {
                c = !0,
                a && a.$pristine && a.$setDirty(),
                i.$apply(function() {
        ...
        function g(t, n, i, o, r, a, s) {
            var l = n.$watch(r, function(r, c) {
                ...
                a && a(),
                t = null ,
                h && u && (h.parentNode.replaceChild(u, h),
                e(i).replaceWith(o)),
                f(o)(n))
            }
            , !0);
            ...
            i = function(t, i) {
                return {
                    ...
                    link: function(a, s, l, c) {
                        ...
                        h.attr(u, h.attr("data-" + u)),
                        h[0].removeAttribute("data-" + u),
                        d = r(a, s, l, t, i, c),
                        d && (n && clearTimeout(n),
                        n = setTimeout(function() {
                            a.$emit("kendoRendered"),
                            o || (o = !0,
                ...
                if (d.length > 0)
                    ...
                    case "compile":
                        ...
                        t.forEach(d, function(t, i) {
                            var o, r;
                            c.scopeFrom ? o = c.scopeFrom : (r = h && h[i],
        ...
        w("ui.Select", "$angular_setLogicValue", function(e) {
            var t = this.self
              ...
              , r = i.text || "";
            e === n && (e = ""),
            o && !i.valuePrimitive && e && (r = e[i.dataTextField] || "",
            e = e[o || i.dataTextField]),
            t.options.autoBind !== !1 || t.listView.isBound() ? t.value(e) : !r && e && i.valuePrimitive ? t.value(e) : t._preselect(e, r)
        }
        ),
        ...
        w("ui.MultiSelect", "$angular_setLogicValue", function(t) {
            ...
            o = i.dataValueField,
            r = t,
            o && !i.valuePrimitive && (t = e.map(t, function(e) {
                return e[o]
            }
            )),
        ...
        w(["ui.Grid", "ui.ListView", "ui.TreeView"], "$angular_makeEventHandler", function(e, n, i) {
            ...
            function(e) {
                var o, r, a, s, l, c, d, h, u, f = e.sender, p = f.options, g = {
                    kendoEvent: e
                };
                ...
                l = g.columns = [],
                d = 0; a.length > d; d++)
                    h = o ? a[d].parentNode : a[d],
                    u = f.dataItem(h),
                    o ? (t.element.inArray(u, s) < 0 && s.push(u),
                    c = t.element(a[d]).index(),
                    t.element.inArray(c, l) < 0 && l.push(c)) : s.push(u);
