...
hicon.area = hicon.area || {};

hicon.area.addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea, provinceChangeCb, cityChangeCb) {
    var cmbProvince = _cmbProvince instanceof $ ? _cmbProvince[0] : $('#' + _cmbProvince)[0];
    var cmbCity = _cmbCity instanceof $ ? _cmbCity[0] : $('#' + _cmbCity)[0];
    var cmbArea = _cmbArea instanceof $ ? _cmbArea[0] : $('#' + _cmbArea)[0];

    provinceChangeCb = $.isFunction(provinceChangeCb) ? provinceChangeCb : $.noop;
    cityChangeCb = $.isFunction(cityChangeCb) ? cityChangeCb : $.noop;
    ...
    function cmbAddOption(cmb, str, obj)
    {
        ...
        option.value = (str.indexOf('请选择')>-1) ? '' : str;
        option.obj = obj;
    }
    ...
    function changeProvince()
    {
        ...
        cmbCity.onchange = function(){
            changeCity.call(this);
            cityChangeCb.call(this);
        };
    }
    ...
    cmbProvince.onchange = function(){
        changeProvince.call(this);
        provinceChangeCb.call(this);
    };
}

var provinceList = [
    {name:'请选择省份', cityList:[
        {name:'请选择城市', areaList:['请选择县/区']}
    ]},
    {name:'北京市', cityList:[
    ...
    {name:'海南省', cityList:[
        ...
        {name:'三亚市', areaList:['海棠湾镇','田独镇','凤凰镇','崖城镇','天涯镇','育才镇']},
        {name:'五指山市', areaList:[]},
        {name:'琼海市', areaList:[]},
        {name:'儋州市', areaList:[]},
        {name:'文昌市', areaList:[]},
